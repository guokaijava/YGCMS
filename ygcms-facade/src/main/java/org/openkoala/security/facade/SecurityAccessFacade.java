...
public interface SecurityAccessFacade {
	...
	Page<CmsSiteDTO> pagingQueryGrantSiteResourcesByRoleId(int page,int pagesize, Long roleId, CmsSiteDTO dto);

	Page<CmsSiteDTO> pagingQueryNotGrantSiteResourcesByRoleId(int page,int pagesize, Long roleId, CmsSiteDTO dto);

	List<CmsSiteDTO> getSiteListByRoleId(Long roleId);
}
