    ...
    <script>
        ...
        $(function(){
            ...
            $.get(url,function(data){
                ...
                var $li = $('<li class="folder"><a data-toggle="collapse" href="#menuMark'+this.id+'" aria-controls="menuMark'+this.id+'"><span class="'+this.menuIcon+'"></span>&nbsp;'+this.name+'&nbsp;'+
                            '<i class="glyphicon glyphicon-chevron-right" style=" float: right;font-size: 12px;position: relative;right: 8px;top: 3px;"></i></a><ul id="menuMark'+this.id+'" class="second-level-menu collapse"></ul></li>');
                    ...
                    firstLevelMenu.find('[data-toggle="collapse"]').each(function(){
                        ...
                        firstLevelMenu.find($(this).attr('href')).on({
                            'shown.bs.collapse': function(e){
                                $this.find('i:last').addClass('glyphicon-chevron-right').removeClass('glyphicon-chevron-left');
                            },
                            'hidden.bs.collapse': function(e){
                                $this.find('i:last').removeClass('glyphicon-chevron-left').addClass('glyphicon-chevron-right');
                                $this.attr("class","collapsed");
                                $this.siblings().attr("class","second-level-menu collapse");
                            }
                        });
                    });
            },"json");
...
<body>
	...
	<div class="g-head">
	    <nav class="navbar navbar-default">
	        <a class="navbar-brand" href="#">
	        	...
	        	<span style="font-weight:800;">网站后台管理系统</span>
	        </a>
    ...
    <%-- 底部 --%>
	<div id="footer" class="g-foot"><span>Copyright © 2015 YGCMS</span></div>
</body>
</html>