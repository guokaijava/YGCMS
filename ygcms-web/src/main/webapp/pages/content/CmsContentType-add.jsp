...
<form class="form-horizontal">
	...
	<div class="form-group">
		...
		<div class="col-lg-9" style="padding-top:6px;">
			<input name="hasimage" type="radio" value="1"/>&nbsp;是&nbsp;&nbsp;&nbsp;
			<input name="hasimage" type="radio" value="0" checked/>&nbsp;否
		</div>
	</div>
	<div class="form-group">
		<label class="col-lg-3 control-label">禁用:</label>
		<div class="col-lg-9" style="padding-top:6px;">
			<input name="isdisabled" type="radio" value="1"/>&nbsp;是&nbsp;&nbsp;&nbsp;
			<input name="isdisabled" type="radio" value="0" checked/>&nbsp;否
		</div>
	</div>
	<div class="form-group">
