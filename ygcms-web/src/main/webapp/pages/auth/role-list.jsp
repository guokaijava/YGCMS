	...
	$(function() {
		...
		var buttons = (function() {
            return [{
                ...
                content : '<ks:hasSecurityResource identifier="roleManagerGrantSite"><button class="btn btn-info" type="button"><span class="glyphicon glyphicon-th-large"></span>&nbsp;分配站点</button></ks:hasSecurityResource>',
                action : 'siteAssign'
            },{
		...
		$('[data-role="roleGrid"]').grid({
			...
			'siteAssign' : function(event, data) {
				var items = data.item;
				var $this = $(this);
				if (items.length == 0) {
					$this.message({
				...
				var page = items[0];
				openTab('/pages/auth/role-grant-site.jsp', page.name+'的站点资源管理', 'roleGrantSiteManager_' + page.id, page.id, {pageId : page.id});
			},
