...
<form class="form-horizontal">
	...
	<div class="form-group">
		...
		<div class="col-lg-4" style="padding-top:6px">
			<input name="issingle"  type="radio" id="issingleID1" value="1" checked/>&nbsp;是&nbsp;&nbsp;&nbsp;&nbsp;
			<input name="issingle"  type="radio" id="issingleID2" value="0"/>&nbsp;否
		</div>
		<label class="col-lg-2 control-label">是否显示:</label>
		<div class="col-lg-4" style="padding-top:6px">
			<input name="isdisplay"  type="radio" id="isdisplayID1" value="1" checked/>&nbsp;是&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<div class="form-group">
		...
		<div class="col-lg-4" style="padding-top:6px">
			<input name="iscustom"  type="radio" id="iscustomID1" value="1" checked/>&nbsp;是&nbsp;&nbsp;&nbsp;&nbsp;
