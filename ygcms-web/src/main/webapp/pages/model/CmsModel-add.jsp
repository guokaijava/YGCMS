	...
	<form class="form-horizontal">
		...
		<div class="form-group">
			...
			<div class="col-lg-9" style="padding-top:5px;">
				<input name="hascontent" type="radio" value="1" />是&nbsp;&nbsp;&nbsp;&nbsp;<input
					name="hascontent" type="radio" value="0" checked />否
			</div>
		</div>
		<div class="form-group">
			<label class="col-lg-3 control-label">是否启用:</label>
			<div class="col-lg-9" style="padding-top:5px;">
				<input name="isdisabled" type="radio" value="1"  />是&nbsp;&nbsp;&nbsp;&nbsp;<input
					name="isdisabled" type="radio" value="0"  checked />否
			</div>
		</div>

		<input name="isdef" style="display: inline; width: 94%;"
			class="form-control" type="hidden" id="isdefID" value=""/>
	</form>
