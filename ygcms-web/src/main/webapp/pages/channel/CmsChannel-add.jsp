...
<form class="form-horizontal" style="min-height:450px;height:450px">
      ...
      <div class="tab-content" id="myTabContent" style="padding-top:20px;height:440px;overflow-y:auto;overflow-x:hidden">
